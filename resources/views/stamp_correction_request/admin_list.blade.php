...
<div style="background-color: #F0EFF2; min-height: calc(100vh - 80px); padding: 32px; margin: -24px;">
    <div style="max-width: 1512px; margin: 0 auto; background-color: #FFFFFF; border-radius: 12px; padding: 32px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        <h2 style="font-family: 'Inter', sans-serif; font-weight: 700; font-size: 32px; margin-bottom: 24px; color: #000000;">申請一覧（管理者）</h2>
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        <thead>
                            <tr style="background-color: #F5F5F5; border-bottom: 2px solid #E0E0E0;">
                                <th style="padding: 16px; text-align: left; font-family: 'Inter', sans-serif; font-weight: 700; font-size: 16px; color: #000000;">申請者</th>
                            ...
                            @foreach($pendingRequests as $request)
                                <tr style="border-bottom: 1px solid #E0E0E0;">
                                    ...
                                    <td style="padding: 16px;">
                                        <a href="{{ route('admin.stamp_correction_request.approve.detail', $request->id) }}" style="padding: 8px 16px; background-color: #000000; color: #FFFFFF; text-decoration: none; border-radius: 8px; font-family: 'Inter', sans-serif; font-weight: 700; font-size: 14px;">詳細</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        <div style="margin-top: 32px;">
            <a href="{{ route('admin.attendance.list') }}" style="padding: 12px 32px; background-color: #E0E0E0; color: #000000; text-decoration: none; border-radius: 8px; font-family: 'Inter', sans-serif; font-weight: 700; font-size: 16px; display: inline-block;">戻る</a>
        </div>
    </div>
</div>
@endsection
