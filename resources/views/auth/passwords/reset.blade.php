...
<head>
    ...
    <title>新しいパスワード設定 - CoachTech</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <main class="main-content">
        <div class="auth-container">
            <h1 class="auth-title">新しいパスワード設定</h1>
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" class="form-input @error('email') error @enderror" value="{{ old('email', $request->email) }}" required>
                    @error('email')
